odoo.define('custom_odoo_settings.title', function(require) {
"use strict";
    ...
    start: function () {
        ...
        this._rpc({
            ...
            .then(function (result) {
                obj.set('title_part', {"zopenerp": "CrowdAfrica"});  // Replacing the name 'Oodo' to selected company name near favicon
            });
    },
});
